...
/* Constructor */
template<class T>
Portal::DHCPOptionsNumber<T>::DHCPOptionsNumber(short_word code, T value) : DHCPOptions(code,NumberTag), value(value) {
	/* Now, set the payload */
	SetPayload();
}
...
template<class T>
void Portal::DHCPOptionsNumber<T>::SetPayload() {
	word net_value = 0;
...
template<class T>
void Portal::DHCPOptionsNumber<T>::SetFields() {
...
template<class T>
void Portal::DHCPOptionsNumber<T>::PrintData() const {
	/* Now, set the payload */
	std::cout <<  value;
}
...
/* Destructor */
template<class T>
Portal::DHCPOptionsNumber<T>::~DHCPOptionsNumber() { }
