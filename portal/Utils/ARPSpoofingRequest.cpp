...
void* Portal::ARPSpoofRequest(void* thread_arg) {
	/* Get the ARP context */
...
void Portal::ARPNormalRequest(void* thread_arg) {
	/* Get the ARP context */
	ARPContext* context = static_cast<ARPContext* >(thread_arg);
...
ARPContext* Portal::ARPSpoofingRequest(const std::string& net_target, const std::string& net_victim, const string& iface) {
